      ...
      <div className="login-form">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                render={({ field }) => (
                  <FormItem className="flex-column">
                    ...
                    <div className="login-input-form">
                      <svg height={20} viewBox="0 0 32 32" width={20} xmlns="http://www.w3.org/2000/svg" className="fill-current text-muted-foreground">
                        <g id="Layer_3" data-name="Layer 3">
                          <path d="m30.853 13.87a15 15 0 0 0 -29.729 4.082 15.1 15.1 0 0 0 12.876 12.918 15.6 15.6 0 0 0 2.016.13 14.85 14.85 0 0 0 7.715-2.145 1 1 0 1 0 -1.031-1.711 13.007 13.007 0 1 1 5.458-6.529 2.149 2.149 0 0 1 -4.158-.759v-10.856a1 1 0 0 0 -2 0v1.726a8 8 0 1 0 .2 10.325 4.135 4.135 0 0 0 7.83.274 15.2 15.2 0 0 0 .823-7.455zm-14.853 8.13a6 6 0 1 1 6-6 6.006 6.006 0 0 1 -6 6z" />
                        </g>
                      </svg>
                      <FormControl>
                        <Input type="email" className="login-input" placeholder="Enter your Email" {...field} />
                      </FormControl>
                    </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex-column">
                    ...
                    <div className="login-input-form">
                       <svg height={20} viewBox="-64 0 512 512" width={20} xmlns="http://www.w3.org/2000/svg" className="fill-current text-muted-foreground">
                        <path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0" />
                        <path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0" />
                      </svg>
                      <FormControl>
                        <Input type="password" className="login-input" placeholder="Enter your Password" {...field} />
                      </FormControl>
                    </div>
                     <FormMessage className="text-red-500 text-xs" />
                  </FormItem>
            ...
            <div className="login-flex-row mt-4">
              <FormField
                control={form.control}
                name="rememberMe"
                render={({ field }) => (
                  <FormItem className="flex items-center space-x-2">
                    <FormControl>
                      <Checkbox 
                        ...
                        className="h-4 w-4 rounded border-gray-500 bg-zinc-800 text-primary focus:ring-primary"
                      />
                    </FormControl>
                    <FormLabel className="text-sm !text-gray-300 !font-normal">Remember me</FormLabel>
                  </FormItem>
                )}
              />
        ...
        <p className="login-p">Don't have an account? <Link href="/signup"><span className="login-span">Sign Up</span></Link></p>
        <p className="login-p line my-4">Or With</p>
        <div className="flex flex-col gap-3 mt-2">
          <button 
            type="button"
            className="flex items-center justify-center gap-3 w-full py-3 px-4 border-2 border-primary/20 rounded-xl bg-primary/5 hover:bg-primary/10 transition-all font-bold text-sm" 
            onClick={handleGoogleSignIn}
          >
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 512 512" style={{enableBackground: 'new 0 0 512 512'}} xmlSpace="preserve">
            ...
            <span className="text-primary tracking-tight">Continue with Google</span>
          </button>
        </div>
      </div>
    </div>
